...
urlpatterns = [
    ...
    path('profile/<str:pk>/chapters', views.chapters, name='chapters'),
    path('profile/<str:pk>/chapter/<str:ch>', views.chapter, name='chapter'),
    path('chapter/join/<str:chapter_link>', dashboard_views.chapter_join_link, name='chapter-join-link'),
