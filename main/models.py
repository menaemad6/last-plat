...
class Profile(models.Model):
    ...
    qr_code = models.ImageField(upload_to='qr-codes' , default='blank-lecture.jpeg' , blank=True , null=True)
...
class Part(models.Model):
    ...
    bunnyCDN = models.CharField(blank=True , max_length=500)
...
class AssignmentOpen(models.Model):
    ...
    alterShuffle = models.BooleanField(default=False)
...
class Answer(models.Model):
    ...
    question_id = models.CharField(max_length=500)
    question_number = models.IntegerField(default=0 , blank=True)
    virtual_number = models.IntegerField(default=0 , blank=True)
