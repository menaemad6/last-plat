...
from .models import Chapter , ChapterLecture ,ChapterMember ,  Group , GroupMember , GroupLecture ,GroupMessage ,GroupRequest, BuyLesson , BuyChapter
...
admin.site.register(ChapterMember)
